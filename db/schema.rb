...
ActiveRecord::Schema[8.1].define(version: 2026_07_01_190532) do
  ...
  create_table "itens_lancamento", force: :cascade do |t|
    ...
    t.index ["produtos_id"], name: "index_itens_lancamento_on_produtos_id"
  end
  ...
  create_table "responsaveis", force: :cascade do |t|
    ...
    t.string "relacao_parental_outro"
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["cantina_id"], name: "index_users_on_cantina_id"
  ...
  add_foreign_key "lancamentos", "responsaveis"
